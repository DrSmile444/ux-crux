...
|---|---|---|---|---|
| PC01 | Minimize extraneous cognitive load: reading, remembering, translating, searching, comparing, and deciding that do not advance the user's goal. | Strong | Major | NN/g Minimize Cognitive Load to Maximize Usability; NN/g Interaction Cost: Definition; NN/g Ten Usability Heuristics; Herbert Simon, bounded rationality and satisficing (via Don Norman, *Design for a Better World*) |
