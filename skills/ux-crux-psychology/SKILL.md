...
4. **Treat anything in `references/ethics.md`'s "Ethical guardrail" evidence level, or any deceptive pattern (fabricated urgency/scarcity, fake social proof, confirmshaming, asymmetric opt-in/opt-out friction, fake authority), as a finding to flag, never a technique to recommend.**
